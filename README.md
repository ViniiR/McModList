...
Unused
[Prometheus](https://modrinth.com/mod/prometheus-api)
...
> [!IMPORTANT]
> Requires java 22
> can download alpha version but it greatly increases cpu temps

Unused
[ImmediatelyFast](https://modrinth.com/mod/immediatelyfast)

[Voxy](https://modrinth.com/mod/voxy)
> Set render distance to 5 (and simulation), and voxy render to 32(via config file) offers great performance benefits.
...
Unused
[Homeostatic](https://modrinth.com/mod/homeostatic)
...
[Map Distance Fix](https://modrinth.com/mod/map-distance-fix)
...
> Does not really offer much on standard world gen
> removed since i believe it may cause higher temps for not much benefit

Unused
[Homeostatic Seasons](https://modrinth.com/mod/homeostatic-seasons)
> Great but removed for performance's sake
...
> Terralith's biomes ruin 1.18+ ore generation.

Unused
[Wilder Wild](https://modrinth.com/mod/wilder-wild)
> Updates and adds new biomes, mobs and items (hollow savanna termite wood)
...
Unused
[MMV - Moog's Missing Villages](https://modrinth.com/mod/mmv-moogs-missing-villages)

Unused
[Abridged](https://modrinth.com/mod/abridged)

Unused
[ATi Structures](https://modrinth.com/datapack/ati-structures-fabricforge)
> Structure loot is overpowered
...
## Notable mods or textures that aren't available for 1.21.11
...
> Incompatible with sodium 0.6.0+



## Notable mods that don't fit this pack
